package src.Coding_Problems.PBL.Java_Fundamentals;// Write a Program that accepts two Strings as command line arguments and generate the output in the required format.
